            ...
            <table class="min-w-full divide-y divide-gray-200">
              <thead class="bg-yellow-400">
                <tr>
                  <th
                    scope="col"
                    class="py-3.5 px-4 text-sm font-bold text-left rtl:text-right text-gray-900"
                  >
                    <button
                  ...
                  <th
                    scope="col"
                    class="px-12 py-3.5 text-sm font-bold text-left rtl:text-right text-gray-900"
                  >
                    Sex
                  </th>
              ...
              <tbody class="bg-white divide-y divide-gray-200">
                <tr v-for="(user, index) in props.users.data" :key="index">
                  ...
                  <td
                    class="px-12 py-4 whitespace-nowrap"
                    :class="user.sex == 0 ? 'text-pink-600' : 'text-blue-600'"
                  >
                    <div class="flex gap-1">
