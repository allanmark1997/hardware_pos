            ...
            <div class="h-full border-2 border-gray-100 shadow-md rounded-lg overflow-hidden group">
              ...
              <div class="p-4">
                ...
                <div class="flex justify-center">
                  <button type="button"
                    class=" bg-transparent text-orange-500 hover:text-orange-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center">
                    Show More
  ...
  <JetDialogModal :show="updateModal" @close="updateModal = false" maxWidth="2xl">
    ...
    <template #content>
      <div class="grid grid-cols-12 gap-1">
        ...
        <div class="col-span-12">
          <Input type="text" label="Specification title" v-model="form_update.description.specification.spec_title" />
          <!-- <JetInputError
              :message="form.errors.description.specification.spec_title"
              class="mt-2"
            /> -->
        </div>
        <div v-if="form_update.description.specification.spec_title != ''" class="col-span-3">
          <Input type="text" label="Specification name" v-model="specification.spec_name" />
          <JetInputError :message="spec_name" class="mt-2" />
        </div>
        <div v-if="form_update.description.specification.spec_title != ''" class="col-span-6">
        ...
        <div v-if="form_update.description.specification.spec_title != ''" class="col-span-3 mx-auto mt-3">
        ...
        <div v-if="form.post_images == 0" class="col-span-12 flex items-center justify-center w-full mt-4"
