          ...
          >
            ...
            >
              ...
              <div class="p-4">
                ...
                <div class="flex">
                  <p
                    class="flex leading-relaxed text-xs truncate"
                  ...
                  <p
                    class="flex leading-relaxed mb-3 text-xs truncate"
      ...
      <div class="grid grid-cols-12 gap-1">
        ...
        <div class="col-span-12">
          <Input
            type="text"
            label="Image"
            v-model="form_update.product_image"
          />
          <JetInputError
            :message="form_update.errors.product_image"
            class="mt-2"
          />
        </div>
      </div>
