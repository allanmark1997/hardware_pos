        ...
        <div class="grid grid-cols-12 gap-2">
          ...
          <div class="col-span-5   ">
            ...
            <div class="bg-white flex justify-between item-center p-5">
              ...
              <button type="button" class="focus:outline-none text-white bg-yellow-600 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 ">Charge</button>
