...
<template>
  <Head :title="'Welcome'" />
  <div
    :class="`relative sm:flex sm:justify-center sm:items-center min-h-screen bg-center bg-no-repeat bg-[url('${props.logo}')] bg-gray-700 bg-blend-multiply`"
  >
    ...
    <div class="max-w-7xl mx-auto p-6 lg:p-8">
      <div class="flex justify-center">
        <img class="mx-auto py-auto" src="" alt="" />
      </div>
      ...
      <div class="mt-16">
        <div class="text-center">
          ...
          >
            <a
              :href="route('cashier.index_transaction')"
            ...
            <a
              :href="route('cashier.index_return')"
              class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-yellow-700 hover:bg-yellow-800 focus:ring-4 focus:ring-yellow-300"
            >
              Return Items
              <svg
                class="w-3.5 h-3.5 ml-2"
