    ...
    <div class="py-">
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="flex justify-between">
          <div class="flex">
            <Input v-model="search" class="rounded-lg mb-2 w-[30vmin]" type="text" label="Search supplier"
              @keyup.enter="search_" />
          ...
          <button @click="open_modal_add" class="bg-yellow-400 p-2 mb-2 mt-5 rounded-lg w-[20vmin] hover:bg-yellow-500">
            Add Supplier
          </button>
        </div>
      ...
      <template #content>
        ...
        <div class="grid grid-cols-12 gap-2">
          ...
          <div class="col-span-12">
            <Input label="Supplier's name" type="text" class="mt-1 block w-full" v-model="form.supplier_name" autofocus />
            <JetInputError :message="form.errors.supplier_name" class="mt-2" />
          </div>
          <div class="col-span-12">
            <Input label="Contact No" type="text" class="block w-full" v-model="form.mobile_no" autofocus />
            <JetInputError :message="form.errors.mobile_no" class="mt-2" />
          </div>
          <div class="col-span-12">
            <Input label="Supplier's Address" type="text" class="block w-full" v-model="form.address" autofocus />
