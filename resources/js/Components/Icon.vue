...
const icon_default = props.icon ?? "user";
const icons = {
  cart: "cart",
  user: "user",
  calendar: "calendar",
...
<template>
  ...
  <svg
    v-if="icon_default === icons.shopping_bag"
    fill="none"
    :class="size"
    stroke="currentColor"
    stroke-width="1.5"
  ...
  <svg
    fill="none"
    g
    v-if="icon_default === icons.search_icon"
    :class="size"
    stroke="currentColor"
    stroke-width="1.5"
    viewBox="0 0 24 24"
  ...
  <svg
    fill="none"
    :class="size"
    v-if="icon_default === icons.shopping_cart"
    stroke="currentColor"
    stroke-width="1.5"
    viewBox="0 0 24 24"
    xmlns="http://www.w3.org/2000/svg"
  ...
  <svg
    fill="none"
    v-if="icon_default === icons.qr_code"
    :class="size"
    stroke="currentColor"
    stroke-width="1.5"
    viewBox="0 0 24 24"
  ...
  <svg
    fill="none"
    v-if="icon_default === icons.close_icon"
    :class="size"
    class="text-red-800"
    stroke="currentColor"
    stroke-width="1.5"
  ...
  <svg
    v-if="icon_default === icons.arrow_path"
    :class="size"
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
  ...
  <svg
    v-if="icon_default === icons.pencil"
    :class="size"
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
  ...
  <svg  v-if="icon_default === icons.forwardArrow"  :class="size" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
  <path stroke-linecap="round" stroke-linejoin="round" d="M17.25 8.25L21 12m0 0l-3.75 3.75M21 12H3"></path>
</svg>


<svg fill="none" lass="w-6 h-6" v-if="icon_default === icons.docs" :class="size" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
